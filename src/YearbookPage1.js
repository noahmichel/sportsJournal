...
import { NavBarLogout, MarketingFooter2, Classof2021 } from './ui-components'
import './NavBar2.css'
...
async function savePDF () {
    ...
    await html2canvas(input,{ logging: true, letterRendering: 1, allowTaint: true, useCORS: true }).then(canvas => {
        ...
        const pdf = new jsPDF('p', 'pt', [ 595.28,  841.89]);
        pdf.addImage(imgData, 'JPEG', 1, 0, 595.28,  841.89);
        Storage.put("yearbookPage1.pdf", pdf.output('arraybuffer'), {
        ...
        <div style={{backgroundColor: 'black'}}>
            ...
            <div style={{padding: '54px 0px 75px 0px', backgroundColor: 'black'}}>
                ...
                >
                    ...
                    <Classof2021 id="capture" border="2px SOLID gray" borderRadius="2px"/>
...
export default withAuthenticator(YearbookPage1);