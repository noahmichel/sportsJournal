      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7gtz")}
          >
            <Text
              fontFamily="Inter"
              fontSize="40px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividerhzt")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7gdy")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerkze")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7gxg")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28car")}
          >
            <Button
              ...
              isDisabled={true}
              variation="primary"
              {...getOverrideProps(overrides, "Buttonfna")}
            ></Button>
            <Button
              display="flex"
              width="75px"
              ...
              size="large"
              variation="primary"
              {...getOverrideProps(overrides, "Buttonsne")}
            ></Button>
            <Button
              display="flex"
              width="74px"
              ...
              size="large"
              variation="primary"
              {...getOverrideProps(overrides, "Buttonnqc")}
            ></Button>
            <Button
              display="flex"
              width="75px"
              ...
              size="large"
              variation="primary"
              {...getOverrideProps(overrides, "Buttonubg")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28usx")}
          >
            <Button
              gap="24px"
              display="flex"
              ...
              size="large"
              variation="primary"
              {...getOverrideProps(overrides, "Buttonzgy")}
            ></Button>
            <Button
              gap="24px"
              display="flex"
              ...
              size="large"
              variation="primary"
              {...getOverrideProps(overrides, "Buttonglw")}
            ></Button>
            <Button
              gap="24px"
              display="flex"
              ...
              size="large"
              variation="primary"
              {...getOverrideProps(overrides, "Buttoncqz")}
            ></Button>
            <Button
              gap="24px"
              display="flex"
              ...
              size="large"
              variation="primary"
              {...getOverrideProps(overrides, "Buttonjed")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
