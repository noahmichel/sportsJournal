...
export default function NavBar(props) {
  const { navLogo, overrides, ...rest } = props;
  return (
    <Flex
      gap="20px"
      direction="row"
    ...
    >
      <Flex
        ...
        {...getOverrideProps(overrides, "Logojbj")}
      >
        <Icon
          width="18px"
          height="18px"
        ...
        <Text
          ...
          about="First Button"
          children="Home"
          {...getOverrideProps(overrides, "Logosjy")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 321wik")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 321vry")}
      >
        <SearchField
          display="flex"
          width="300px"
