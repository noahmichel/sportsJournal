...
export default function AnswerQuestion5(props) {
  ...
  return (
    ...
    >
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="How did you pitch today?"
    ...
    <Wrapper>
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Fill out how you felt you pitched today."
        {...getOverrideProps(
          overrides,
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Question 5/5"
        {...getOverrideProps(overrides, "Question 5/5")}
      ></Text>
      <Image
        width="450px"
        height="270px"
      ...
      ></Image>
      <Link to="/journal/beginnerComplete" style={{textDecoration: 'none'}}>
        <Button
          children="Next"
