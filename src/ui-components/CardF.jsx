      ...
      >
        ...
        >
          <Badge
            ...
            size="small"
            variation="default"
            {...getOverrideProps(overrides, "Badgepbc")}
          ></Badge>
          <Badge
            padding="4px 8px 4px 8px"
            display="flex"
            ...
            size="small"
            variation="default"
            {...getOverrideProps(overrides, "Badgevur")}
          ></Badge>
          <Badge
            padding="4px 8px 4px 8px"
            display="flex"
            ...
            size="small"
            variation="default"
            {...getOverrideProps(overrides, "Badgelpg")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurepes")}
          >
            <Icon
              width="24px"
              height="24px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featureeef")}
          >
            <Icon
              width="24px"
              height="24px"
              ...
              type="check"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconsih")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurekzh")}
          >
            <Icon
              width="24px"
              height="24px"
              ...
              type="check"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconehq")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
